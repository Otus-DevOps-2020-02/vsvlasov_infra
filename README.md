...
- Добавлен Vagrant для локального тестирования Ansible
- Доработаны роли db и app для тестирования на локальном окружении
- Добавлены настройки Nginx в Vagrantfile для доступа по 80 порту
- Добавлен Molecule для тестирования ролей
- Роли db и app переиспользованы для Packer
